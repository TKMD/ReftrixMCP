...
describe("Webdesign Schema - モデル存在確認", () => {
  describe("WebPage モデル", () => {
    ...
    it("WebPage の必須フィールドが正しく定義されていること", () => {
      ...
      // 必須フィールド確認
      const requiredFields: WebPageFields[] = ["url", "sourceType", "usageScope"];
...
describe("Webdesign Schema - リレーション確認", () => {
  ...
  describe("SectionEmbedding リレーション", () => {
    ...
    it("SectionEmbedding の sectionPatternId がユニーク制約を持つこと", () => {
      ...
      type SectionEmbeddingUniqueFields = keyof Prisma.SectionEmbeddingWhereUniqueInput;
  ...
  describe("MotionEmbedding リレーション", () => {
    ...
    it("MotionEmbedding の motionPatternId がユニーク制約を持つこと", () => {
      type MotionEmbeddingUniqueFields = keyof Prisma.MotionEmbeddingWhereUniqueInput;
...
describe("Webdesign Schema - インデックス確認", () => {
  ...
  it("WebPage でソート可能なフィールドが定義されていること", () => {
    ...
    const sortableFields: WebPageOrderByFields[] = ["crawledAt", "createdAt", "updatedAt"];
  ...
  it("SectionPattern でソート可能なフィールドが定義されていること", () => {
    type SectionPatternOrderByFields = keyof Prisma.SectionPatternOrderByWithRelationInput;
  ...
  it("QualityEvaluation でソート可能なフィールドが定義されていること", () => {
    type QualityEvaluationOrderByFields = keyof Prisma.QualityEvaluationOrderByWithRelationInput;
