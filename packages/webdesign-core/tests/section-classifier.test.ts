  ...
  describe("Initialization", () => {
      ...
      const customRules: ClassificationRule[] = [
        {
          type: "hero",
          priority: 100,
          conditions: [{ field: "tagName", operator: "equals", value: "header", weight: 1 }],
          minConfidence: 0.5,
        },
      ];
    ...
    it("should allow adding custom rules via addRule()", () => {
      ...
      classifier.addRule({
        type: "hero",
        priority: 200,
        conditions: [{ field: "classes", operator: "contains", value: "custom-hero", weight: 1 }],
        minConfidence: 0.8,
      });
  ...
  describe("Custom Rules", () => {
    ...
    it("should support hasAny operator for arrays", () => {
      ...
      customClassifier.addRule({
        type: "cta",
        priority: 120,
        conditions: [{ field: "content", operator: "hasAny", value: ["button"], weight: 0.8 }],
        minConfidence: 0.5,
      });
      const section = createSection({
        content: {
      ...
      const customClassifier = new SectionClassifier([
        {
          type: "hero",
          priority: 100,
          conditions: [{ field: "classes", operator: "contains", value: "special", weight: 1 }],
          minConfidence: 0.5,
        },
        {
          type: "feature",
    ...
    it("should break ties by confidence when priorities equal", () => {
      ...
      const customClassifier = new SectionClassifier([
        ...
        },
        {
          type: "feature",
          priority: 100,
          conditions: [{ field: "classes", operator: "contains", value: "test", weight: 1 }],
          minConfidence: 0.3,
        },
      ]);
      const section = createSection({
