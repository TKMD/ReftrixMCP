      ...
      const context = createMockDesignContext({
        sections: [
          createMockSection("hero", {
            style: {
              hasGradient: true,
              backgroundColor: "linear-gradient(#FF0000, #00FF00, #0000FF)",
            },
          }),
          createMockSection("feature", {
            style: {
              hasGradient: true,
              backgroundColor: "linear-gradient(#AA00FF, #00FFAA, #FFAA00)",
            },
          }),
          createMockSection("cta", {
            style: {
              hasGradient: true,
              backgroundColor: "linear-gradient(#123456, #654321, #ABCDEF)",
            },
          }),
        ],
      });
