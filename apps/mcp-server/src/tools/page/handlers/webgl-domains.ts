 ...
 * ```
 */
export function getDomainsByCategory(category: WebGLDomainEntry["category"]): WebGLDomainEntry[] {
 ...
 * ```
 */
export function getDomainsByTier(tier: WebGLDomainEntry["tier"]): WebGLDomainEntry[] {
 ...
 */
export const LEGACY_ULTRA_HEAVY_DOMAINS: readonly string[] = getDomainsByTier("ultra-heavy").map(
  (e) => e.domain
);
 ...
 */
export const LEGACY_HEAVY_DOMAINS: readonly string[] = getDomainsByTier("heavy").map(
  (e) => e.domain
);
 ...
 */
export const LEGACY_ALL_DOMAINS: readonly string[] = KNOWN_WEBGL_DOMAINS.map((e) => e.domain);
