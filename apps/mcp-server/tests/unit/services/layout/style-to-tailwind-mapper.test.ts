  ...
  describe("mapStyleToTailwind", () => {
    ...
    describe("変換不可スタイルの保持", () => {
      it("未対応のCSSプロパティはstyleとして残す", () => {
        ...
        expect(result.remainingStyles).toHaveProperty("boxShadow", "0 4px 6px rgba(0, 0, 0, 0.1)");
      ...
      it("CSS変数を含むスタイルはstyleとして残す", () => {
        ...
        expect(result.remainingStyles).toHaveProperty("backgroundColor", "var(--primary-color)");
