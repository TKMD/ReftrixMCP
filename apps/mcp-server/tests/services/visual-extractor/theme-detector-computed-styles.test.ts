...
import type { ThemeDetectorService } from "../../../src/services/visual-extractor/theme-detector.service";
  ...
  describe("detectThemeWithComputedStyles", () => {
    ...
    describe("6. E&A Financial real-world case", () => {
      it("should correctly detect E&A Financial as dark theme", async () => {
        ...
        const ambiguousScreenshot = await createSolidColorImage(100, 100, {
          r: 150,
          g: 150,
          b: 150,
        });

        const result = await service.detectThemeWithComputedStyles(
          ambiguousScreenshot,
          computedStyles
        );
