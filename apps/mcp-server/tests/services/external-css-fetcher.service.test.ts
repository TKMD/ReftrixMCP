  ...
  describe("extractCssUrls", () => {
    it('link rel="stylesheet" タグからhrefを抽出する', () => {
      ...
      (mockFetcher.extractCssUrls as ReturnType<typeof vi.fn>).mockReturnValue([
        ...
        {
          url: "https://example.com/pages/components/button.css",
          originalHref: "./components/button.css",
          media: "screen",
        },
        {
          url: "https://example.com/shared/reset.css",
          originalHref: "../shared/reset.css",
          type: "text/css",
        },
      ]);
    ...
    it("@import URLをstyle要素から抽出する", () => {
      (mockFetcher.extractCssUrls as ReturnType<typeof vi.fn>).mockReturnValue([
        {
          url: "https://fonts.example.com/fonts.css",
          originalHref: "https://fonts.example.com/fonts.css",
          fromImport: true,
        },
        {
          url: "https://example.com/pages/local/styles.css",
          originalHref: "local/styles.css",
          fromImport: true,
        },
  ...
  describe("extractImportUrls", () => {
    it("@import url() 形式を抽出する", () => {
      (mockFetcher.extractImportUrls as ReturnType<typeof vi.fn>).mockReturnValue([
        {
          url: "https://cdn.example.com/reset.css",
          originalHref: "https://cdn.example.com/reset.css",
          fromImport: true,
        },
        {
          url: "https://example.com/pages/components/button.css",
    ...
    it("@import '...' 形式を抽出する", () => {
      (mockFetcher.extractImportUrls as ReturnType<typeof vi.fn>).mockReturnValue([
        {
          url: "https://example.com/pages/variables.css",
          originalHref: "variables.css",
          fromImport: true,
        },
      ]);
...
describe.skip("ExternalCssFetcher - 実装完了後テスト", () => {
  ...
  it("実際の実装が存在することを確認", async () => {
    ...
    const implementationPath = path.join(__dirname, "../../src/services/external-css-fetcher.ts");
