...
describe("DifferenceDetectorService — Phase 2: computedStyleベース検出", () => {
  ...
  describe("セマンティック要素の可視性変化検出", () => {
    ...
    it("should include display/visibility/opacity details in diff", () => {
      ...
      // mobile側の詳細
      expect(visDiff?.mobile).toEqual(expect.objectContaining({ visible: false, display: "none" }));
    });
  });
});
...
describe("DifferenceDetectorService — Phase 4: 拡張タイポグラフィ・スペーシング", () => {
  ...
  describe("拡張タイポグラフィ検出（h1-h6 + p:first-of-type）", () => {
    ...
    it("should not detect heading changes below 15% threshold", () => {
      ...
      const typoDiffs = result.differences.filter((d) => d.category === "typography");
      const headingDiffs = typoDiffs.filter((d) => d.element === "h1" || d.element === "h2");
  ...
  describe("セクション間スペーシング検出", () => {
    it("should detect section margin-top change above 20% threshold", () => {
      ...
      const featuresDiff = spacingDiffs.find(
        (d) => d.element === "section.features" && d.description?.includes("margin-top")
      );
      ...
      const pricingDiff = spacingDiffs.find(
        (d) => d.element === "section.pricing" && d.description?.includes("margin-top")
      );
    ...
    it("should detect section margin-bottom change above 20% threshold", () => {
      ...
      const captures = [
        createCaptureResult({
          ...
          width: 1920,
          spacing: defaultSpacing,
          sectionSpacing: [{ selector: "section.hero", marginTop: 0, marginBottom: 100 }],
        }),
        createCaptureResult({
          name: "mobile",
          width: 375,
          spacing: defaultSpacing,
          sectionSpacing: [{ selector: "section.hero", marginTop: 0, marginBottom: 40 }],
        }),
      ];
      ...
      const bottomDiff = spacingDiffs.find(
        (d) => d.element === "section.hero" && d.description?.includes("margin-bottom")
      );
    ...
    it("should not detect section margin changes below 20% threshold", () => {
      ...
      const captures = [
        createCaptureResult({
          ...
          width: 1920,
          spacing: defaultSpacing,
          sectionSpacing: [{ selector: "section.content", marginTop: 60, marginBottom: 50 }],
        }),
        createCaptureResult({
          name: "mobile",
          width: 375,
      ...
      const sectionMarginDiffs = result.differences.filter(
        (d) => d.category === "spacing" && d.element === "section.content"
      );
    ...
    it("should skip section spacing when sectionSpacing is empty", () => {
      ...
      const sectionDiffs = result.differences.filter(
        (d) => d.category === "spacing" && d.element !== "body" && d.element !== "main"
      );
    ...
    it("should skip section spacing when only one viewport has data", () => {
      ...
      const captures = [
        createCaptureResult({
          ...
          width: 1920,
          spacing: defaultSpacing,
          sectionSpacing: [{ selector: "section.hero", marginTop: 80, marginBottom: 60 }],
        }),
        createCaptureResult({
          name: "mobile",
          width: 375,
      ...
      const sectionDiffs = result.differences.filter(
        (d) => d.category === "spacing" && d.element === "section.hero"
      );
      expect(sectionDiffs).toHaveLength(0);
    });
    ...
    it("should skip section when selector not found in smaller viewport", () => {
      ...
      const captures = [
        createCaptureResult({
          ...
          width: 1920,
          spacing: defaultSpacing,
          sectionSpacing: [{ selector: "section.desktop-only", marginTop: 80, marginBottom: 60 }],
        }),
        createCaptureResult({
          name: "mobile",
          width: 375,
          spacing: defaultSpacing,
          sectionSpacing: [{ selector: "section.mobile-only", marginTop: 40, marginBottom: 30 }],
        }),
      ];
    ...
    it("should include percentage in spacing description", () => {
      ...
      const captures = [
        createCaptureResult({
          ...
          width: 1920,
          spacing: defaultSpacing,
          sectionSpacing: [{ selector: "section.cta", marginTop: 100, marginBottom: 0 }],
        }),
        createCaptureResult({
          name: "mobile",
          width: 375,
          spacing: defaultSpacing,
          sectionSpacing: [{ selector: "section.cta", marginTop: 50, marginBottom: 0 }],
        }),
      ];
      ...
      const ctaDiff = result.differences.find(
        (d) => d.element === "section.cta" && d.description?.includes("margin-top")
      );
    ...
    it("should detect differences across all categories simultaneously", () => {
      const captures = [
        createCaptureResult({
          ...
          sectionSpacing: [{ selector: "section.hero", marginTop: 100, marginBottom: 80 }],
          spacing: {
        ...
        createCaptureResult({
          ...
          sectionSpacing: [{ selector: "section.hero", marginTop: 40, marginBottom: 30 }],
          spacing: {
