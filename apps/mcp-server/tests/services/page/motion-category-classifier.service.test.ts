...
import type { MotionCategoryClassifier } from "../../../src/services/page/motion-category-classifier.service";
import {
  ...
  describe("inferTriggerType", () => {
    ...
    describe("property-based inference", () => {
      ...
      it('should return "load" for opacity and transform combined', () => {
        const result = classifier.inferTriggerType(".animate", ["opacity", "transform"]);
    ...
    describe("default behavior", () => {
      it('should return "unknown" for unrecognized selector and properties', () => {
        const result = classifier.inferTriggerType(".custom-class", ["background-color", "border"]);
  ...
  describe("inferCategory", () => {
    ...
    describe("marquee category", () => {
      ...
      it('should return "marquee" for scroll-left animation name', () => {
        const result = classifier.inferCategory(
          "scroll-left",
          ".element",
          ["transform"],
          "infinite"
