...
describe("generateJsAnimationTextRepresentation", () => {
  ...
  describe("ライブラリ検出情報", () => {
    it("GSAP検出時、Libraries行にGSAPが含まれる", () => {
      const cdpAnim = createCdpAnimation();
      const jsAnimations = createJsAnimations([cdpAnim], [], { gsap: { detected: true } });
    ...
    it("anime.js検出時、anime.jsが含まれる", () => {
      const cdpAnim = createCdpAnimation();
      const jsAnimations = createJsAnimations([cdpAnim], [], { anime: { detected: true } });
  ...
  describe("フォールバック", () => {
    ...
    it("フォールバック時もライブラリ情報は付加される", () => {
      const jsAnimations = createJsAnimations([], [], { gsap: { detected: true } });
