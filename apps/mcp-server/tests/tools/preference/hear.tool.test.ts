...
const MOCK_PROGRESS = {
  ...
  remaining_reason: 'ヒアリング未開始。5カテゴリの評価が必要です / Hearing not started. 5 categories need evaluation',
  ...
  describe('モードA: サンプル提示', () => {
    ...
    it('progress の HearingProgress 全フィールドが正しい型で返される', async () => {
      const customProgress = {
        ...
        remaining_reason: '未評価のデザインカテゴリが3/5件あります / 3/5 design categories not yet evaluated',
        should_continue: true,
    ...
    it('confidence が 0.8 以上の場合 should_continue が false', async () => {
      const highConfidenceProgress = {
        ...
        remaining_reason: '嗜好プロファイルの信頼度が十分に高いため、ヒアリングを終了できます。 / Preference profile confidence is sufficient to end the hearing.',
